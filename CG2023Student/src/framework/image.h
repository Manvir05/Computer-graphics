...
public:
    ...
    void DrawThickLineDDA(int x0, int y0, int x1, int y1, int thickness, const Color &c);
    //Change thickness of the lines
    void DrawLineBresenham(int x0, int y0, int x1, int y1, const Color &c);
    void DrawThickLineBresenham(int x0, int y0, int x1, int y1, int thickness, const Color &c);
    ...
    float Slope(const Vector2 p0, const Vector2 p1);
    
    void ScanLineBresenham(int x0, int y0, int x1, int y1, std::vector<myCell> &table);
    
    void DrawTriangleInterpolated(const TriangleInfo &triangle, FloatImage* zbuffer);
